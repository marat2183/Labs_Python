...
def slau_3(tab):
    ...
    text_main.grid(row=1, column=1, columnspan=8)
    text_1 = tk.Label(tab, text='Введите СЛАУ:',font=("Arial", 16, "bold"))
    text_1.grid(row=3, column=0, columnspan=4, sticky='w', padx = 5)
    inp_1 = tk.Entry(tab)
