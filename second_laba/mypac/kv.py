...
def run_kv(tab):
    ...
    text_main = tk.Label(tab, text='Решение квадратных уравнений', font=("Arial", 16, "bold"))
    text_main.grid(row=1, column=0, columnspan=5, sticky='w', padx = 15)
    text_1 = tk.Label(tab, text='Введите квадратное уравнение:',font=("Arial", 16, "bold"))
    text_1.grid(row=3, column=0, columnspan=4, sticky='w', padx=10)
    inp_1 = tk.Entry(tab)
    inp_1.grid(row=5,column=0)
    text_2 = tk.Label(tab, text='X^2',font=("Arial", 16, "bold"))
    ...
    text_4 = tk.Label(tab, text='X', font=("Arial", 16, "bold"))
    text_4.grid(row=5, column=4)
    text_5 = tk.Label(tab, text='+',font=("Arial", 16, "bold"))
    text_5.grid(row=5, column=5)
    inp_3 = tk.Entry(tab)
    inp_3.grid(row=5, column=6)
    text_6 = tk.Label(tab, text='=',font=("Arial", 16, "bold"))
    text_6.grid(row=5, column=7)
    text_7 = tk.Label(tab, text='0',font=("Arial", 16, "bold"))
    text_7.grid(row=5, column=8)
    but = tk.Button(tab, text='Решить',font=("Arial", 16, "bold"), command=calculate).grid(row=7, column=0, columnspan=4)
    btn = tk.Button(tab, text='Очистить экран вывода',font=("Arial", 16, "bold"), command=clear).grid(row=7, column=4, columnspan=8)
    # root.mainloop()